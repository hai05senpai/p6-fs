...
export const CVItem = (props: {
  ...
  const workingFrom = workingFromOptions.find(work => work.value === item.jobWorkingFrom)?.label;
  ...
  return (
    <>
      ...
      >
        ...
        <div className={
          "mt-[6px] flex justify-center items-center gap-[8px] font-[400] text-[14px] " + (item.viewed ? "text-[#0088FF]" : "text-[#FF0000]")
          }>
