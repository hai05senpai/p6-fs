...
export default async function JobDetailPage({ params }: {
  ...
  if(data.code == "success") {
    ...
    jobDetail.workingFrom = workingFromOptions.find((item) => item.value == jobDetail.workingFrom)?.label || jobDetail.workingFrom;
  }
            ...
            <div className="flex flex-wrap gap-[20px]">
              ...
              <div className="lg:w-[65%] w-[100%]">
                ...
                <div className="border border-[#DEDEDE] rounded-[8px] p-[20px]">
                  ...
                  <Link href="#formApply" className="bg-[#0088FF] rounded-[4px] font-[700] text-[16px] text-white flex items-center justify-center h-[48px] mb-[20px]">
                    Ứng tuyển
                  </Link>
                  <div className="grid grid-cols-3 sm:gap-[16px] gap-[8px] mb-[20px]">
                    {jobDetail.images.map((item: string, index: number) => (
                      <img 
                        ...
                        src={item}
                        alt="" 
                        className="aspect-[232/145] w-full object-cover rounded-[4px]"
                      />
                    ))}
                  </div>
                  ...
                  <div className="flex items-center gap-[8px] font-[400] text-[14px] text-[#121212] mb-[10px]">
                    <FaBriefcase className="text-[16px]" /> {jobDetail.workingFrom}
                  </div>
                  <div className="flex items-center gap-[8px] font-[400] text-[14px] text-[#121212] mb-[10px]">
